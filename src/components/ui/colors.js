const ColorWidget = ({ setColor }) => {
  return (
    <div id="color-tooltip">
      ...
      <div
        className="color-option tooltip"
        style={{ backgroundColor: "#ff9f80" }}
        onClick={() => setColor("#ff9f80")}
      >
        <span className="tooltip-text">Red</span>
      </div>
      <div
        className="color-option tooltip"
        style={{ backgroundColor: "#ffd280" }}
        onClick={() => setColor("#ffd280")}
      >
      ...
      <div
        ...
        onClick={() => setColor("#b3ffb3")}
      >
        <span className="tooltip-text">Green</span>
      </div>
      <div
        className="color-option tooltip"
        style={{ backgroundColor: "#01ffff" }}
        onClick={() => setColor("#01ffff")}
      >
      ...
      <div
        ...
        onClick={() => setColor("#b3b3ff")}
      >
        <span className="tooltip-text">Blue</span>
      </div>
      <div
        className="color-option tooltip"
        style={{ backgroundColor: "#5982ff" }}
        onClick={() => setColor("#5982ff")}
      >
      ...
      <div
        ...
        onClick={() => setColor("#ffdae0")}
      >
        <span className="tooltip-text">Pink</span>
      </div>
      <div
        className="color-option tooltip"
        style={{ backgroundColor: "#e08787" }}
        onClick={() => setColor("#e08787")}
      >
      ...
      <div
        className="color-option tooltip"
        style={{ backgroundColor: "#fadbfa" }}
        onClick={() => setColor("#fadbfa")}
      >
